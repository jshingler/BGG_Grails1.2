...
public class TodoJava {
  ...
  public TodoJava(String name, String note) {
    this.name = name;
    this.note = note;
  }
  ...
  public static void main(String[] args) {
    ...
    todos.add(new TodoJava("1", "one"));
    todos.add(new TodoJava("2", "two"));
    todos.add(new TodoJava("3","three"));

    for(Iterator iter = todos.iterator();iter.hasNext();) {
      TodoJava todo = (TodoJava)iter.next();
