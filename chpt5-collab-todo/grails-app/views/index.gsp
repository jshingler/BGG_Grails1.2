<html>
    ...
    <body>
		...
		<div id="pageBody">
	        ...
	        <p>Welcome to the Collab-Todo application.  This application was built
           ...
           <br />
           <p>Building the Collab-Todo
           application is used to walk the user through using Grails 1.2 to
